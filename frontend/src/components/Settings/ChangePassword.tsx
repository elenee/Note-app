        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            <input
              ...
              className={`w-full border rounded-lg px-4 py-3 border-[hsla(219,15%,82%,1)] dark:border-[hsla(222,11%,36%,1)] ${errors.oldPassword ? "border-[hsla(355,96%,60%,1)]" : ""}`}
            />
            <button
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            <input
              ...
              className={`w-full border rounded-lg px-4 py-3 border-[hsla(219,15%,82%,1)] dark:border-[hsla(222,11%,36%,1)] ${errors.newPassword ? "border-[hsla(355,96%,60%,1)]" : ""}`}
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            <input
              ...
              className={`w-full border rounded-lg px-4 py-3 border-[hsla(219,15%,82%,1)] dark:border-[hsla(222,11%,36%,1)] ${errors.confirmNewPassword ? "border-[hsla(355,96%,60%,1)]" : ""}`}
